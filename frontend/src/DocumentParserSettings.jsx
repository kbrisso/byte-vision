...
const FormInput = ({ label, id, type = 'text', value, onChange, className = 'w-50' }) => (
    <div className="mb-3">
...
export const DocumentParserSettings = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        const result = await CreateEmbedding(
            ...
            formData.filePath,
            formData.dbPath,
            parseInt(formData.chunkSize),
            parseInt(formData.chunkOverlap),
            ...
            <Card>
                <Card.Body>
                    ...
                    <form onSubmit={handleFormSubmit}>
                        ...
                        <FormInput label="File path" id="filePath" value={formData.filePath} onChange={handleFormChange} />
                        <FormInput label="DB path" id="dbPath" value={formData.dbPath} onChange={handleFormChange} />
                        <FormInput label="Chunk size" id="chunkSize" type="number" value={formData.chunkSize} onChange={handleFormChange} className="w-25" />
                        <FormInput label="Chunk overlap" id="chunkOverlap" type="number" value={formData.chunkOverlap} onChange={handleFormChange} className="w-25" />
                        <FormInput label="Collection name" id="collectionName" value={formData.collectionName} onChange={handleFormChange} className="w-25" />
                        <FormInput label="Meta data" id="metaData" value={formData.metaData} onChange={handleFormChange} className="w-25" />
                        <FormInput label="Meta data key" id="metaDataKey" value={formData.metaDataKey} onChange={handleFormChange} className="w-25" />
